        ...
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100">
                    <form action="{{ route('login') }}" class="login100-form validate-form p-l-55 p-r-55 p-t-178" method="POST">
                        @csrf
                        <span class="login100-form-title">
                            Sign In Operator
                        </span>
                        <div class="wrap-input100 validate-input" data-validate = "Please enter token">
                            <input class="input100" type="text" name="email" value="{{Session::get('email')}}" placeholder="Masukkan Email">
