        ...
        <div class="row align-items-center py-4 px-xl-5">
            ...
            <div class="col-lg-3 text-right">
                <div class="d-inline-flex align-items-center">
                    ...
                    <div class="text-left">
                        <h6 class="font-weight-semi-bold mb-1">Email Resmi</h6>
                        ...
                        <div class="navbar-nav py-0">
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href={{route('berita.index2')}} class="dropdown-item">Berita</a>
                                    <a href={{route('album.index2')}} class="dropdown-item">Galeri</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Informasi</a>
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href={{route('pengumuman.index2')}} class="dropdown-item">Pengumuman</a>
                                </div>
                            </div>
                            </div>
                        </div>
                        <a class="btn btn-primary py-2 px-4 ml-auto d-none d-lg-block" href={{route('index')}}>Login Operator</a>
                    </div>
                </nav>
            </div>
        </div>
            ...
            <div class="col-lg-7 col-md-12">
                <div class="row">
                    <div class="col-md-6 mb-5">
                        <h5 class="text-primary text-uppercase mb-4" style="letter-spacing: 5px;">SMP Negeri 4 Tilatang Kamang</h5>
